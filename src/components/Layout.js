...
const Layout = ({ location, template, title, description, article, children }) => {
    ...
    return (
        <Fragment>
            <SEO location={location} template={template} title={title} description={description} article={article} />
